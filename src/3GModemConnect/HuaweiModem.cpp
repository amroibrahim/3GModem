...
CHuaweiModem::CHuaweiModem(CString sPort)
:CModem(sPort)
{

}

CHuaweiModem::~CHuaweiModem(void)
{
}

BOOL CHuaweiModem::Initialize(CWnd* pEventWnd)
{
#ifdef _LOG
...
void CHuaweiModem::ProcessLine(const char *sLine)
{
	if (!sLine)
	{
		return;
...
void CHuaweiModem::Process_RSSI_Msg(char* szMsg)
{
	/*
...
void CHuaweiModem::Process_Revision(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
...
void CHuaweiModem::Process_IMEI(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
...
void CHuaweiModem::Process_CSQ_Msg(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
...
void CHuaweiModem::Process_CGDCONT_Msg(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
...
void CHuaweiModem::Process_SYSCFG_Msg(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
	...
	EModemMode eMode = CModem::eMODE_ANY;
	EModemBand eBand = CModem::eBAND_ANY;
	BOOL bPref = TRUE;
	char szModeOnly[5];
	char szModePref[5];
	char szBand[10];
	...
	pToken = strtok_s( szMsg, szSepsMsg, &pNextToken );
	strncpy_s(szModeOnly, 5, strtok_s( NULL, szSepsMsg, &pNextToken ), _TRUNCATE);
	strncpy_s(szModePref, 5, strtok_s( NULL, szSepsMsg, &pNextToken ), _TRUNCATE);
	strncpy_s(szBand, 10, strtok_s( NULL, szSepsMsg, &pNextToken ), _TRUNCATE);
...
void CHuaweiModem::Process_COPS_Msg(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
...
void CHuaweiModem::Process_COPN_Msg(char* szMsg)
{
...
void CHuaweiModem::Process_DSFLOWRPT_Msg(char* szMsg)
{
	/*
...
void CHuaweiModem::Process_MODE_Msg(char* szMsg)
{
	/*
	^MODE: N1, N2
	N1:
...
void CHuaweiModem::Process_Manufacturer(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
...
void CHuaweiModem::Process_Model(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
...
void CHuaweiModem::Process_Hardware(char* szMsg)
{
	char szSepsMsg[]   = ":,"; //to split a single message
	char *pToken = NULL;
	char *pNextToken = NULL;
